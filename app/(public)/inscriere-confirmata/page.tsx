  ...
  return (
    <div className="bg-brand-bg text-text-body font-body min-h-svh">
      ...
      <section className="relative overflow-hidden px-5 py-10 md:py-16">
        <Ornament nume="buchet" marime={230} opacitate={0.12} className="text-primary-800 -right-8 top-4" />
        ...
        <div className="relative mx-auto max-w-[var(--container-form)]">
          ...
          <p className="text-body text-text-muted mt-3">
            ...
            uită-te și în Promoții sau Spam — și marcheaz-o ca &bdquo;nu e spam&rdquo;, ca
            să primești și reamintirile.
          </p>
            ...
            <>
              <div className="mt-6">
                <Fisa
                  randuri={[
                    ...
                    { eticheta: 'Când', valoare: formateazaDataOra(webinar.starts_at) },
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="border-primary-800 text-primary-800 hover:bg-primary-50 min-h-touch inline-flex flex-1 items-center justify-center rounded-full border-[1.5px] px-6 font-semibold"
                >
                  Adaugă în Google Calendar
                </a>
                <a
                  href={`/api/calendar/${webinar.slug}`}
                  className="border-brand-border text-text-muted hover:bg-surface min-h-touch inline-flex flex-1 items-center justify-center rounded-full border px-6 font-medium"
                >
          ...
          {webinar?.bonus_title && (
            <p className="text-body-sm text-text-muted bg-surface-botanic rounded-brand-md mt-6 p-4">
              <strong className="text-sage-800">Nu uita:</strong> {webinar.bonus_title} îl
